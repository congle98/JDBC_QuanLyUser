...
public class UserDAO implements IUserDAO{
    ...
    private String jdbcPassword = "034266145";
    ...
    public List<User> findUsersByCountry(String country) {
        ...
        try {
            ...
            while (resultSet.next()){
                ...
                String ctry = resultSet.getString("country");
                userList.add(new User(id,name,email,ctry));
            }
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    public void addUserTransaction(User user, int[] permisions) {
        ...
        try {
            ...
            //thêm mới user và lấy ra key của user đó
